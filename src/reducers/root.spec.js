...
describe('root selectors', () => {
	...
	describe('wrestlers', () => {
		...
		describe('getWrestler', () => {
			test('returns the appropriate state.', () => {
				expect(getWrestler(initialState, 0)).toEqual(fromWrestlers.getWrestler(initialState.wrestlers, 0));
			});
		});

		describe('getWrestlers', () => {
			test('returns the appropriate state.', () => {
				expect(getWrestlers(initialState)).toEqual(fromWrestlers.getWrestlers(initialState.wrestlers));
			});
		});
	});
